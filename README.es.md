...
- **Turno nocturno** — marca torrents para descargarlos sólo dentro de una ventana horaria configurada; los completados siguen sembrando
...
| `LISTEN_ADDR` | No | `127.0.0.1:8080` (imagen Docker: `0.0.0.0:8080`) |
